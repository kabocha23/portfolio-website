const projectsData = [
  {
    ...
    description:
      "A web application to look up the current weather, allowing you to search today's weather or the forecast for the next five days. Built with React and OpenWeatherMap API.",
